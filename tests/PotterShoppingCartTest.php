...
class PotterShoppingCartTest extends PHPUnit_Framework_TestCase
{
     ...
     */
    public function test_buy_1_first_and_second_episode__2_thrid_episode_of_Harry_Potter()
    {
        // arrange
        $books = [
            new Book(1, "哈利波特第一集", 100),
     ...
     */
    public function test_buy_1_first_episode_2_second_and_thrid_episode_of_Harry_Potter()
    {
        // arrange
        $books = [
            new Book(2, "哈利波特第二集", 100),
